...
kbcommands()
{
	...
	then
		...
		# Then look for Linux "aplay" second...
	...
	then
		...
		# Also, /tmp/1KHz-Test.sh, /tmp/VERT_BAT.BAT, /tmp/VERT_SOX.sh, /tmp/VERT_DSP.sh
		# and /tmp/Arduino_9600.pde will be left intact _IF_ any are generated by
